...
function TasteProfileVisual() {
  ...
  return (
    <div style={{position:'absolute', right:24, bottom:24, width:280, display:'flex', flexDirection:'column', gap:8}}>
      {users.map((u,i)=>(
...
function ListsVisual() {
  ...
  return (
    <div style={{position:'absolute', right:24, bottom:24, width:260, display:'grid', gridTemplateColumns:'1fr 1fr', gap:8}}>
      {lists.map((l,i)=>(
...
function MapVisual() {
  return (
    <div style={{position:'absolute', right:24, bottom:24, width:280, height:160, borderRadius:18, overflow:'hidden', background:'rgba(255,255,255,0.18)', backdropFilter:'blur(8px)', boxShadow:'0 12px 28px -12px rgba(38,23,18,0.4)', border:'1px solid rgba(255,255,255,0.25)'}}>
