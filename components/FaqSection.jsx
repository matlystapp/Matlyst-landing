...
function FaqSection() {
  const items = [
    ...
    ['¿Dónde puedo descargar Matlyst?', 'Ya lo está. Matlyst está disponible para descargar gratis en la App Store. La versión de Android llegará más adelante.'],
    ['¿Matlyst es gratuita?', 'Sí. Descargarla y usarla es gratis.'],
    ...
    ['¿Dónde está disponible Matlyst?', 'Matlyst funciona en cualquier parte del mundo. Si tu amigo vive en Ciudad de México y tú en Madrid, verás sus restaurantes favoritos de México. Si viajas a Buenos Aires, descubres qué recomienda tu gente allí. Matlyst va contigo y con las personas que te importan, sin fronteras.'],
